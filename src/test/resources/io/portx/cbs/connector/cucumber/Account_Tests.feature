Feature: Test Account Operations using BDD approach
  ...
  Scenario: Test Schema validator SR Account 001 AccountType
    Given I have the account payload located at "test-data/json/mambuAPI/create-account/schema-validator/createAccountRequest_SV_001_AccountType_OBA.json" that I want to create an account
    ...
    And I receive a schema validator exception error for Account scenario like this json response "test-data/json/mambuAPI/create-account/schema-validator/createAccountResponse_SV_001_AccountType_OBA.json"

  Scenario: Test Schema validator SR Account 002 OwnershipType
    Given I have the account payload located at "test-data/json/mambuAPI/create-account/schema-validator/createAccountRequest_SV_002_OwnershipType_OBA.json" that I want to create an account
    When I try to create an account using the API
    Then I check that the status code coming from createAccount from the API response is "400"
    And I receive a schema validator exception error for Account scenario like this json response "test-data/json/mambuAPI/create-account/schema-validator/createAccountResponse_SV_002_OwnershipType_OBA.json"

  Scenario: Test Schema validator SR Account 003 PartyType
    Given I have the account payload located at "test-data/json/mambuAPI/create-account/schema-validator/createAccountRequest_SV_003_PartyType_OBA.json" that I want to create an account
    When I try to create an account using the API
    Then I check that the status code coming from createAccount from the API response is "400"
    And I receive a schema validator exception error for Account scenario like this json response "test-data/json/mambuAPI/create-account/schema-validator/createAccountResponse_SV_003_PartyType_OBA.json"
